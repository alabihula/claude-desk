...
export const desktop = {
  ...
  exportRunDiagnostic: (conversationId, runId, destinationPath) => invoke('export_run_diagnostic', { conversationId, runId, destinationPath }),
  ...
  respondClaudeQuestion: (conversationId, runId, requestId, answers, cancelled = false) => invoke('respond_claude_question', { conversationId, runId, requestId, answers, cancelled }),
